...
var LightSidebarPage = (function () {
    function LightSidebarPage(app) {
        this.app = app;
        app.setPageLightSidebar(true);
    }
    LightSidebarPage.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('page-with-light-sidebar-ready'));
    };
    LightSidebarPage = __decorate([
        core_1.Component({
...
exports.LightSidebarPage = LightSidebarPage;
//# sourceMappingURL=page-with-light-sidebar.js.map