...
var RightSidebarPage = (function () {
    function RightSidebarPage(app) {
        this.app = app;
        app.setPageRightSidebar(true);
    }
    RightSidebarPage.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('page-with-right-sidebar-ready'));
    };
    RightSidebarPage = __decorate([
        core_1.Component({
...
exports.RightSidebarPage = RightSidebarPage;
//# sourceMappingURL=page-with-right-sidebar.js.map