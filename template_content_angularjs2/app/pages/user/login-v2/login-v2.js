...
var LoginV2Page = (function () {
    function LoginV2Page(app, router) {
        this.app = app;
        this.router = router;
    ...
    LoginV2Page.prototype.submitForm = function (form) {
        this.router.navigate(['/']);
        return false;
    };
    LoginV2Page.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('page-login-v2-ready'));
    };
    LoginV2Page = __decorate([
        core_1.Component({
            selector: 'login-v2',
            templateUrl: './app/pages/user/login-v2/login-v2.html'
        }), 
        __metadata('design:paramtypes', [app_component_1.AppComponent, router_1.Router])
    ], LoginV2Page);
    return LoginV2Page;
}());
exports.LoginV2Page = LoginV2Page;
