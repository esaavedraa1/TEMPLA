...
var ExtraComingSoonPage = (function () {
    function ExtraComingSoonPage(app) {
        this.app = app;
    ...
    ExtraComingSoonPage.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('page-extra-coming-soon-ready'));
    };
    ExtraComingSoonPage = __decorate([
        core_1.Component({
    ...
    return ExtraComingSoonPage;
}());
exports.ExtraComingSoonPage = ExtraComingSoonPage;
//# sourceMappingURL=extra-coming-soon.js.map