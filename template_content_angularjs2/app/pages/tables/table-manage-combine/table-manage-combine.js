...
var TableManageCombinePage = (function () {
    function TableManageCombinePage() {
    }
    TableManageCombinePage.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('table-manage-combine-ready'));
    };
    TableManageCombinePage = __decorate([
        core_1.Component({
    ...
    return TableManageCombinePage;
}());
exports.TableManageCombinePage = TableManageCombinePage;
//# sourceMappingURL=table-manage-combine.js.map