...
var TableManageAutofillPage = (function () {
    function TableManageAutofillPage() {
    }
    TableManageAutofillPage.prototype.ngOnInit = function () {
        window.dispatchEvent(new CustomEvent('table-manage-autofill-ready'));
    };
    TableManageAutofillPage = __decorate([
        core_1.Component({
    ...
    return TableManageAutofillPage;
}());
exports.TableManageAutofillPage = TableManageAutofillPage;
//# sourceMappingURL=table-manage-autofill.js.map